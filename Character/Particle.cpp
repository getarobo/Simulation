...
{
	///TODO
//	m_ConstructPos = make_vector(0.0f, 0.0f, 0.0f);
//	m_Position = make_vector(0.0f, 0.0f, 0.0f);
//	m_Velocity = make_vector(0.0f, 0.0f, 0.0f);
	m_ForceAccumulator = make_vector(0.0f, 0.0f, 0.0f);
	count_force = 0;
	
}

void Particle::applyG(){
	Vector3f g = make_vector<float>(0.0f, 0.0f, -m_Mass*9.81f);
	m_ForceAccumulator += g;
}